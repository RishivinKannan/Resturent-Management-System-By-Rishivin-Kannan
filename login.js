...
function loginval() {
    ...
    if (capcha(cap, ccap)) {
        if (loginuser(luser, lpass)) {
            ...
            cookievalue = escape(document.getElementById("us").value) + ";";
...
function loginuser(a, b) {
    var username = ["ram", "surya"];
    var password = ["21bca0000", "21bca0000"];
    ...
    alert("Enter The incorrect username and password");
    return false;
}
function capcha(a, b) {
    if (a.value == b.value) {
